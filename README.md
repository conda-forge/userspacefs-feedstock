About userspacefs-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/userspacefs-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3608&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/userspacefs-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `userspacefs` can be installed with `conda`:
...
```
mamba install userspacefs
```

It is possible to list all of the versions of `userspacefs` available on your platform with `conda`:
...
```
mamba search userspacefs --channel conda-forge
```
...
mamba repoquery search userspacefs --channel conda-forge

# List packages depending on `userspacefs`:
mamba repoquery whoneeds userspacefs --channel conda-forge

# List dependencies of `userspacefs`:
mamba repoquery depends userspacefs --channel conda-forge
```
